...
describe('Asynchronous observer updates', () => {
  ...
  describe('WAVE metadata before audio', () => {
    ...
    for (const sample of [
      {file: 'cest_id3-before-data.wav', early: true, titles: ['ID3 observer title'], tagTypes: ['ID3v2.3']},
      {file: 'cest_info-id3-cset-before-data.wav', early: true, titles: ['“Mötley” – 10 €', 'ID3 observer title'], tagTypes: ['exif', 'ID3v2.3']},
      {file: 'cest_cset-info-id3-before-data.wav', early: true, titles: ['“Mötley” – 10 €', 'ID3 observer title'], tagTypes: ['exif', 'ID3v2.3']},
      {file: 'cest_info-id3-no-cset.wav', early: false, titles: ['Mötley', 'ID3 observer title'], tagTypes: ['exif', 'ID3v2.3']}
    ]) {
      it(sample.file, async () => {
        ...
        assert.deepEqual(beforeAudio, sample.titles.map(() => sample.early));
